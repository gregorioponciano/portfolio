...
// Função para garantir que o conteúdo seja mostrado em telas maiores
function checkScreenSizeForContacts() {
    var visualizar = document.getElementById('header-contatcs');

    if (window.innerWidth > 1249 && visualizar.style.display === "none") {
        visualizar.style.display = "block";  // Exibe o conteúdo se estiver oculto
    }
}
